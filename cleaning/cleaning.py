...
df_2015 = pd.DataFrame(columns=['target', 'source', 'flow'])
df_2016 = pd.DataFrame(columns=['target', 'source', 'flow'])
df_2017 = pd.DataFrame(columns=['target', 'source', 'flow'])

years = ['2015', '2016', '2017']
output_df = [df_2015, df_2016, df_2017]
